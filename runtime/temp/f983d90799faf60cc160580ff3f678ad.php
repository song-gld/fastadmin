<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\xampp\htdocs\fastadmin\public/../application/admin\view\favorite\add.html";i:1582271224;s:68:"D:\xampp\htdocs\fastadmin\application\admin\view\layout\default.html";i:1576638344;s:65:"D:\xampp\htdocs\fastadmin\application\admin\view\common\meta.html";i:1576638344;s:67:"D:\xampp\htdocs\fastadmin\application\admin\view\common\script.html";i:1576638344;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Ico'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ico" data-rule="" class="form-control" name="row[ico]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Sort'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-sort" data-rule="" class="form-control" name="row[sort]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Keyword'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-keyword" data-rule="" class="form-control" name="row[keyword]" type="text">
        </div>
    </div>
